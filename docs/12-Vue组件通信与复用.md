...
- JSX/TSX 组件写法仅在 `App-vue3/H5-vue3` 链路使用；小程序平台组件默认使用模板语法。
...
- 需要自定义渲染函数时，在 H5/App Vue3 组件中使用 JSX；小程序链路保留模板组件实现。
...
- 在多端共用组件里直接使用 JSX 并要求小程序同构运行，导致编译或运行失败。
...
- JSX 组件是否明确限定在 `App-vue3/H5-vue3` 端使用。
