...
- 用于记录外部教程来源、采集日期、落地文件。
- 仅记录“已落地到切片”的来源。
- 采集日期统一为：`2026-02-11`。

## 来源清单

1. 来源：`https://uniapp.dcloud.net.cn/tutorial/`
- 落地：`docs/01-项目结构.md`、`docs/04-请求与拦截器.md`、`docs/06-多端差异处理.md`
- 主题：uni-app 概念、统一 API、条件编译、多端基础差异

2. 来源：`https://uniapp.dcloud.net.cn/tutorial/project.html`
- 落地：`docs/01-项目结构.md`、`docs/02-路由与页面.md`、`docs/06-多端差异处理.md`、`docs/07-打包发布.md`
- 主题：工程目录与配置职责、`static` 与 `unpackage` 规则、发布注意事项

3. 来源：`https://uniapp.dcloud.net.cn/tutorial/page.html`
- 落地：`docs/01-项目结构.md`、`docs/02-路由与页面.md`、`docs/06-多端差异处理.md`、`docs/08-常见问题.md`
- 主题：页面组织、生命周期边界、白屏与卡顿排查

4. 来源：`https://uniapp.dcloud.net.cn/tutorial/page-path.html`
- 落地：`docs/01-项目结构.md`、`docs/02-路由与页面.md`、`docs/06-多端差异处理.md`、`docs/08-常见问题.md`
- 主题：运行时绝对路径、`@/` 别名、资源与跳转路径规范

5. 来源：`https://uniapp.dcloud.net.cn/tutorial/page-component.html`
- 落地：`docs/05-组件与样式规范.md`、`docs/01-项目结构.md`、`docs/08-常见问题.md`
- 主题：组件引用模式（easycom / script setup / Options API）与排障

6. 来源：`https://uniapp.dcloud.net.cn/tutorial/page-script.html`
- 落地：`docs/01-项目结构.md`、`docs/06-多端差异处理.md`、`docs/07-打包发布.md`、`docs/08-常见问题.md`
- 主题：`js` 引用路径、`npm` 兼容与依赖位置规范

7. 来源：`https://uniapp.dcloud.net.cn/tutorial/page-style.html`
- 落地：`docs/05-组件与样式规范.md`、`docs/08-常见问题.md`
- 主题：`@import` 引用 css 的位置、路径、分号规范
